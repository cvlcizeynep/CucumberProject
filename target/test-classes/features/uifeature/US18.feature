...
And 1Student Info List'te Ansentee görülebilmeli
...
And Student Info List'te Average görülebilmeli
 ...
 And  Kullanıcı choose lessons butonuna tıklar ve dersi seçer
 ...
 And Kullanıcı Please enter absentee yazısı görür
    Then close driver
